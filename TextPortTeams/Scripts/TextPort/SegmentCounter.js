(function () {
    ...
    window.SmsCounter = SmsCounter = (function () {
        ...
        SmsCounter.count = function (text) {
            var count, encoding, length, messages, per_message, remaining, segmentCost, cost;
            segmentCost = $("#hidSMSCost").val();
        ...
        SmsCounter.detectEncoding = function (text) {
            text = text.replace(/ /g, ''); /* RDE. Strip any spaces */
            switch (false) {
