...
namespace TextPort.Controllers
{
    ...
    public class BulkUploadController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (accountId > 0)
            {
                BulkMessagesUpload bulk = new BulkMessagesUpload(accountId, 10);
                return View(bulk);
            }
        ...
        public ActionResult Upload()
        {
            ...
            if (accountId > 0)
            {
                ...
                if (fileHandler.SaveUploadFile(fileContent, accountId, fileName, ref fullPathName))
                {
                    ...
                    if (dt != null)
                    {
                        BulkMessagesUpload bm = new BulkMessagesUpload(accountId, 0);
        ...
        [Authorize(Roles = "User")]
        [HttpPost]
        public PartialViewResult GridOps(BulkMessagesUpload messageData)
        {
